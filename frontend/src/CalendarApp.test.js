...
test("Open class modal when 'Add Class' button is clicked", () => {
  render(<CalendarApp />);
...
test("Create a class and display it in the class list", async () => {
  render(<CalendarApp />);
...
test("Open task modal with the correct date when clicking on a date", async () => {
  render(<CalendarApp />);
